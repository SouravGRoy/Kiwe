    ...
    <div>
      <div className="relative w-full py-28 md:p-14 p-6 mt-6 bg-[#bdd7e3c5] rounded-tl-3xl rounded-tr-3xl text-[#000]">
        {[
          ...
          <h1
            key={index}
            className="font-['Neue_Montreal'] text-2xl md:text-[3.8vw] leading-6 md:leading-[3.7vw] tracking-tight"
          >
            {item}
          </h1>
        ))}
        ...
        <div className="container mx-auto p-4">
          <div className="grid grid-cols-1 md:grid-cols-4 mt-6 gap-4">
            <div>
              <h2 className="text-md font-['Neue_Montreal'] mb-4">
                Our Capabilities:
              </h2>
            </div>
            ...
            {data.slice(0, 2).map((category, index) => (
              <div key={index}>
                <div className="flex flex-row gap-2 mb-3">
                  ...
                  <h3 className="font-['Neue_Montreal'] font-thin text-md mb-2">
                    {category.title}
                  </h3>
                </div>
