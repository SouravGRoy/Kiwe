    ...
    >
      ...
      <div className="absolute inset-0 bg-gray-900 opacity-0 hover:opacity-75 transition-opacity duration-300">
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h2 className="text-xl font-['Neue_Montreal'] mb-2 text-[#ADBBDA] font-semibold">
            {title}
          </h2>
          <p className="text-white font-['Neue_Montreal'] text-center">
            {description}
          </p>
        </div>
      </div>
  ...
  return (
    <div className="md:px-14 px-6 pt-32 md:pt-36 ">
      ...
      <div className="flex justify-between flex-wrap">
        <h1 className="font-['Neue_Montreal'] pt-3 text-md">
          Latest Insights:
        </h1>
      ...
      <div className="flex mt-10 -ml-2">
        <div className="flex flex-wrap justify-center">
          <div className="flex flex-col items-start">
            ...
            />
            <h1 className="px-2 font-['Neue_Montreal'] text-start text-[#EDE8F5]">
          ...
          <div>
            ...
            />
            <h1 className="px-2 font-['Neue_Montreal'] rounded-full border-[1px] text-start text-[#ede8f59a]">
              - In Progress
            </h1>
          </div>
        </div>
